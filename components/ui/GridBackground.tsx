...
const GridBackground = () => {
    ...
    return (
        <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
            ...
            {/* Ambient Colors */}
            <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-purple-500/10 rounded-full blur-[100px] animate-pulse" />
            <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-[100px] animate-pulse delay-1000" />
        </div>
    );
};
